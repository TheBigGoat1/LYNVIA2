...
// ============================================================================
const letterHeader = `[Prénom et Nom]
[Adresse]
...
const assuranceMaladieTemplates: Template[] = [
  {
    id: 'LM-1.1',
    title: 'Demande affiliation assurance de base',
    description: "Demandez votre affiliation à une nouvelle caisse d'assurance maladie obligatoire.",
    fields: z.object({
...
Je reste à votre disposition pour tout renseignement complémentaire.${letterClosing}`,
  ...
  {
    id: 'LM-1.2',
    title: 'Résiliation assurance obligatoire',
    description: "Résiliez votre contrat d'assurance maladie obligatoire pour changer de caisse.",
    fields: z.object({
      currentInsurer: z
        .string()
...
Je vous remercie de bien vouloir m'envoyer une confirmation de la résiliation de mon contrat.${letterClosing}`,
  ...
  {
    id: 'LM-1.3',
    title: "Changement modèle d'assurance",
    description: "Changez de modèle d'assurance (standard, HMO, médecin de famille, etc.).",
    fields: z.object({
...
Je vous remercie de bien vouloir confirmer ce changement et de m'informer des éventuelles modifications de prime.${letterClosing}`,
  ...
  {
    id: 'LM-1.4',
    title: 'Modification de la franchise',
    description: "Modifiez le montant de votre franchise annuelle.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      policyNumber: z.string().min(1, "Numéro de police requis."),
...
Je vous remercie de bien vouloir confirmer cette modification et de m'informer du nouveau montant de ma prime.${letterClosing}`,
  ...
  {
    id: 'LM-1.5',
    title: 'Exclusion couverture accidents',
    description: "Excluez la couverture accident si vous êtes couvert par votre employeur.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      policyNumber: z.string().min(1, "Numéro de police requis."),
...
Je vous remercie de bien vouloir confirmer cette modification et de m'informer de la réduction de prime correspondante.${letterClosing}`,
  ...
  {
    id: 'LM-1.6',
    title: 'Résiliation assurance complémentaire',
    description: "Résiliez une ou plusieurs assurances complémentaires.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      policyNumber: z.string().min(1, "Numéro de police requis."),
...
Je vous prie de bien vouloir confirmer cette résiliation par écrit.${letterClosing}`,
  ...
  {
    id: 'LM-1.7',
    title: 'Contestation refus de prise en charge',
    description: "Contestez un refus de prise en charge de votre assureur.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      policyNumber: z.string().min(1, "Numéro de police requis."),
...
Je vous demande de reconsidérer votre décision et de m'accorder la prise en charge demandée. À défaut, je vous prie de bien vouloir me notifier une décision formelle susceptible de recours.${letterClosing}`,
  ...
  {
    id: 'LM-1.8',
    title: 'Suspension primes pendant service militaire/civil',
    description: "Suspendez vos primes durant le service militaire ou civil.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      policyNumber: z.string().min(1, "Numéro de police requis."),
...
const garantieTemplates: Template[] = [
  {
    id: 'LM-2.1',
    title: 'Avis des défauts',
    description: "Signalez un défaut sur un produit acheté.",
    fields: z.object({
...
À défaut de réponse de votre part dans ce délai, je me réserve le droit de demander une réduction du prix ou l'annulation de la vente.${letterClosing}`,
  ...
  {
    id: 'LM-2.2',
    title: 'Avis des défauts (contrat d\'entreprise)',
    description: "Signalez une malfaçon dans un contrat d'entreprise (travaux, rénovations).",
    fields: z.object({
...
À défaut, je me réserve le droit de faire exécuter les travaux de correction par un tiers à vos frais ou de demander une réduction du prix.${letterClosing}`,
  ...
  {
    id: 'LM-2.3',
    title: 'Défaut toujours présent après réparation',
    description: "Le défaut persiste malgré une tentative de réparation.",
    fields: z.object({
      retailerName: z.string().min(1, "Nom du vendeur requis."),
      retailerAddress: z.string().min(1, "Adresse du vendeur requise."),
      productName: z.string().min(1, "Nom du produit requis."),
...
À défaut, je me réserve le droit de demander l'annulation de la vente et le remboursement intégral.${letterClosing}`,
  ...
  {
    id: 'LM-2.4',
    title: 'Résiliation / échange après 4 réparations',
    description: "Demandez l'annulation ou l'échange après plusieurs réparations infructueuses.",
    fields: z.object({
      retailerName: z.string().min(1, "Nom du vendeur requis."),
      retailerAddress: z.string().min(1, "Adresse du vendeur requise."),
      productName: z.string().min(1, "Nom du produit requis."),
...
const executionContratTemplates: Template[] = [
  {
    id: 'LM-3.1',
    title: 'Relance générale',
    description: "Relancez un débiteur pour une obligation non exécutée.",
    fields: z.object({
...
[Signature]`,
  },
  {
    ...
    description: "Mettez formellement en demeure un débiteur de s'exécuter.",
    fields: z.object({
      debtorName: z.string().min(1, "Nom du débiteur requis."),
      debtorAddress: z.string().min(1, "Adresse du débiteur requise."),
      obligationDescription: z.string().min(10, "Description de l'obligation requise."),
...
Passé ce délai, je me réserve le droit d'entreprendre toutes les démarches judiciaires nécessaires à la défense de mes intérêts, sans autre avis de ma part.${letterClosing}`,
  ...
  {
    id: 'LM-3.3',
    title: 'Mise en demeure suite à retard de livraison',
    description: "Mettez en demeure un vendeur qui n'a pas livré dans les délais.",
    fields: z.object({
...
Passé ce délai, je considérerai la vente comme annulée et exigerai le remboursement intégral des sommes versées, sans préjudice de tous dommages-intérêts.${letterClosing}`,
  ...
  {
    id: 'LM-3.4',
    title: 'Résiliation suite à mise en demeure – vente',
    description: "Résiliez un contrat de vente après une mise en demeure restée sans effet.",
    fields: z.object({
      sellerName: z.string().min(1, "Nom du vendeur requis."),
      sellerAddress: z.string().min(1, "Adresse du vendeur requise."),
...
À défaut, j'entreprendrai les démarches judiciaires nécessaires.${letterClosing}`,
  ...
  {
    id: 'LM-3.5',
    title: 'Résiliation suite à mise en demeure – entreprise',
    description: "Résiliez un contrat d'entreprise (travaux) après mise en demeure.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      workDescription: z.string().min(1, "Description des travaux requise."),
...
Je vous demande de me rembourser la somme de CHF [amountPaid] correspondant aux acomptes versés, dans un délai de 10 jours.${letterClosing}`,
  },
  {
    ...
    description: "Demandez des justificatifs pour une facture ou un service.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
...
Je vous remercie de me les transmettre dans un délai de 10 jours.${letterClosing}`,
  ...
  {
    id: 'LM-3.7',
    title: 'Accord de renonciation à la prescription',
    description: "Proposez un accord de renonciation à la prescription.",
    fields: z.object({
...
Cette renonciation ne constitue pas une reconnaissance de dette et n'emporte aucune reconnaissance de responsabilité de ma part.${letterClosing}`,
  ...
  {
    id: 'LM-3.8',
    title: 'Contestation clause d\'inflation',
    description: "Contestez l'application d'une clause d'inflation par un opérateur.",
    fields: z.object({
...
Je vous demande de maintenir le tarif initial prévu au contrat.${letterClosing}`,
  ...
  {
    id: 'LM-3.9',
    title: 'Utilisation de bons cadeaux',
    description: "Réclamez l'utilisation de bons cadeaux expirés.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
...
Je vous prie de bien vouloir honorer ce bon lors de mon prochain achat.${letterClosing}`,
  ...
  {
    id: 'LM-3.10',
    title: 'Remboursement billet suite annulation vol',
    description: "Demandez le remboursement de votre billet pour un vol annulé.",
    fields: z.object({
...
Je me réserve également le droit de réclamer une indemnisation forfaitaire selon ce même règlement.${letterClosing}`,
  ...
  {
    id: 'LM-3.11',
    title: 'Remboursement frais suite annulation vol',
    description: "Demandez le remboursement des frais engagés suite à une annulation.",
    fields: z.object({
      airline: z.string().min(1, "Nom de la compagnie aérienne requis."),
      airlineAddress: z.string().min(1, "Adresse de la compagnie requise."),
      flightNumber: z.string().min(1, "Numéro de vol requis."),
...
Je joins à la présente les justificatifs correspondants.${letterClosing}`,
  ...
  {
    id: 'LM-3.12',
    title: 'Indemnisation suite retard de vol',
    description: "Demandez une indemnisation pour un retard de vol important.",
    fields: z.object({
      airline: z.string().min(1, "Nom de la compagnie aérienne requis."),
      airlineAddress: z.string().min(1, "Adresse de la compagnie requise."),
      flightNumber: z.string().min(1, "Numéro de vol requis."),
...
Je vous demande de procéder au paiement de cette indemnisation dans un délai de 14 jours.${letterClosing}`,
  ...
  {
    id: 'LM-3.13',
    title: 'Indemnisation bagages',
    description: "Réclamez une indemnisation pour bagages perdus, endommagés ou retardés.",
    fields: z.object({
      airline: z.string().min(1, "Nom de la compagnie aérienne requis."),
      airlineAddress: z.string().min(1, "Adresse de la compagnie requise."),
      flightNumber: z.string().min(1, "Numéro de vol requis."),
...
Je joins à la présente les justificatifs (déclaration PIR, factures, photos).${letterClosing}`,
  },
  {
    ...
    description: "Contestez une facture que vous estimez injustifiée.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      invoiceNumber: z.string().min(1, "Numéro de facture requis."),
...
En attendant, je suspends le paiement de cette facture.${letterClosing}`,
  ...
  {
    id: 'LM-3.15',
    title: 'Contestation facture dépassant le devis',
    description: "Contestez une facture dont le montant dépasse le devis accepté.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      invoiceNumber: z.string().min(1, "Numéro de facture requis."),
...
Je refuse de payer au-delà du montant convenu et vous adresse ce jour le règlement de CHF [quotedAmount].${letterClosing}`,
  ...
  {
    id: 'LM-3.16',
    title: 'Contestation facture prescrite',
    description: "Invoquez la prescription pour une créance trop ancienne.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      invoiceNumber: z.string().min(1, "Numéro de facture requis."),
...
const resiliationTemplates: Template[] = [
  {
    id: 'LM-4.1',
    title: 'Résiliation contrat à son échéance',
    description: "Résiliez un contrat arrivant à son terme.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      contractType: z.string().min(1, "Type de contrat requis."),
...
Je vous prie de bien vouloir me confirmer la résiliation par écrit et de cesser tout prélèvement à compter de cette date.${letterClosing}`,
  ...
  {
    id: 'LM-4.2',
    title: 'Résiliation contrat de mandat',
    description: "Résiliez un contrat de mandat (avocat, conseiller, etc.).",
    fields: z.object({
...
Je vous prie de me restituer tous les documents en votre possession relatifs à ce mandat et de m'adresser votre note d'honoraires finale.${letterClosing}`,
  ...
  {
    id: 'LM-4.3',
    title: 'Résiliation contrat de mandat en temps inopportun',
    description: "Résiliez un mandat avec indemnisation pour résiliation en temps inopportun.",
    fields: z.object({
      mandataryName: z.string().min(1, "Nom du mandataire requis."),
      mandataryAddress: z.string().min(1, "Adresse du mandataire requise."),
      mandateDescription: z.string().min(1, "Description du mandat requise."),
...
Je vous prie de me restituer tous les documents en votre possession.${letterClosing}`,
  ...
  {
    id: 'LM-4.4',
    title: 'Résiliation petit crédit dans les 14 jours',
    description: "Révoquez un contrat de petit crédit dans le délai légal de 14 jours.",
    fields: z.object({
...
Je vous restituerai le montant perçu dans les 30 jours suivant l'envoi de la présente.${letterClosing}`,
  ...
  {
    id: 'LM-4.5',
    title: 'Résiliation leasing dans les 14 jours',
    description: "Révoquez un contrat de leasing dans le délai légal de 14 jours.",
    fields: z.object({
...
Je me tiens à votre disposition pour la restitution de l'objet loué.${letterClosing}`,
  ...
  {
    id: 'LM-4.6',
    title: 'Résiliation suite modification contractuelle',
    description: "Résiliez suite à une modification unilatérale du contrat par le fournisseur.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      contractType: z.string().min(1, "Type de contrat requis."),
...
Je résilie par la présente mon contrat avec effet immédiat.${letterClosing}`,
  ...
  {
    id: 'LM-4.7',
    title: 'Résiliation carte de crédit',
    description: "Résiliez votre carte de crédit.",
    fields: z.object({
...
Je procéderai à la destruction de la carte dès réception de votre confirmation.${letterClosing}`,
  ...
  {
    id: 'LM-4.8',
    title: 'Résiliation assurance après sinistre',
    description: "Résiliez une assurance après la survenance d'un sinistre.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      policyNumber: z.string().min(1, "Numéro de police requis."),
...
Je vous prie de me confirmer cette résiliation et de me rembourser le prorata de prime non utilisé.${letterClosing}`,
  ...
  {
    id: 'LM-4.9',
    title: 'Résiliation fitness pour justes motifs',
    description: "Résiliez votre abonnement de fitness pour des raisons valables.",
    fields: z.object({
...
const annulationTemplates: Template[] = [
  {
    id: 'LM-5.1',
    title: 'Annulation contrat pour erreur essentielle/dol',
    description: "Annulez un contrat pour erreur essentielle ou tromperie.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
...
Je vous demande la restitution de toutes les prestations effectuées.${letterClosing}`,
  ...
  {
    id: 'LM-5.2',
    title: 'Annulation contrat et demande de remboursement',
    description: "Annulez un contrat pour erreur et demandez le remboursement.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      contractDescription: z.string().min(1, "Description du contrat requise."),
...
Conformément aux articles 23 à 28 du Code des obligations, je déclare par la présente l'annulation de ce contrat et vous demande le remboursement de CHF [amountPaid] dans un délai de 10 jours.${letterClosing}`,
  ...
  {
    id: 'LM-5.3',
    title: 'Contestation accord Obligo',
    description: "Contestez un accord Obligo obtenu de manière abusive.",
    fields: z.object({
      creditorName: z.string().min(1, "Nom du créancier requis."),
      creditorAddress: z.string().min(1, "Adresse du créancier requise."),
...
Je conteste la validité de cet accord car il a été obtenu par des moyens contraires aux règles de la bonne foi. Je vous demande de renoncer à toute poursuite basée sur ce document.${letterClosing}`,
  ...
  {
    id: 'LM-5.4',
    title: 'Annulation produit assurance non souhaité',
    description: "Annulez une assurance souscrite sans votre consentement éclairé.",
    fields: z.object({
      insurer: z.string().min(1, "Nom de l'assureur requis."),
      insurerAddress: z.string().min(1, "Adresse de l'assureur requise."),
      productName: z.string().min(1, "Nom du produit requis."),
...
Je n'ai jamais eu l'intention de souscrire ce produit et conteste la validité de ce contrat. Je demande son annulation immédiate et le remboursement de toutes les primes prélevées.${letterClosing}`,
  ...
  {
    id: 'LM-5.5',
    title: 'Annulation faux concours / abonnement piège',
    description: "Annulez un abonnement souscrit via un faux concours.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      subscriptionDate: z.string().min(1, "Date de souscription requise."),
...
const transportAerienTemplates: Template[] = [
  {
    id: 'LM-6.1',
    title: 'Remboursement billet suite annulation',
    description: "Demandez le remboursement de votre billet pour un vol annulé.",
    fields: z.object({
...
Conformément au Règlement européen 261/2004, je demande le remboursement intégral du prix du billet, soit CHF [ticketPrice], dans un délai de 7 jours.${letterClosing}`,
  ...
  {
    id: 'LM-6.2',
    title: 'Remboursement frais suite annulation',
    description: "Réclamez le remboursement des frais engagés suite à une annulation de vol.",
    fields: z.object({
      airline: z.string().min(1, "Compagnie aérienne requise."),
      airlineAddress: z.string().min(1, "Adresse de la compagnie requise."),
      flightNumber: z.string().min(1, "Numéro de vol requis."),
...
Je demande le remboursement de ces frais s'élevant à CHF [totalAmount]. Je joins les justificatifs correspondants.${letterClosing}`,
  ...
  {
    id: 'LM-6.3',
    title: 'Indemnisation suite retard vol',
    description: "Demandez une indemnisation pour un retard de vol important.",
    fields: z.object({
      airline: z.string().min(1, "Compagnie aérienne requise."),
      airlineAddress: z.string().min(1, "Adresse de la compagnie requise."),
...
Je vous demande de procéder au versement de cette indemnisation dans les 14 jours.${letterClosing}`,
  },
  {
    id: 'LM-6.4',
    title: 'Indemnisation bagages',
    description: "Réclamez une indemnisation pour bagages perdus, retardés ou endommagés.",
    fields: z.object({
      airline: z.string().min(1, "Compagnie aérienne requise."),
      airlineAddress: z.string().min(1, "Adresse de la compagnie requise."),
      flightNumber: z.string().min(1, "Numéro de vol requis."),
...
const recouvrementTemplates: Template[] = [
  {
    id: 'LM-7.1',
    title: 'Contestation frais de recouvrement',
    description: "Contestez des frais de recouvrement ou de rappel abusifs.",
    fields: z.object({
...
Je vous demande d'annuler ces frais et de me confirmer le montant exact dû.${letterClosing}`,
  ...
  {
    id: 'LM-7.2',
    title: 'Confirmation contestation frais',
    description: "Confirmez votre contestation de frais de recouvrement.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse requise."),
...
const poursuitesTemplates: Template[] = [
  {
    id: 'LM-8.1',
    title: 'Opposition au commandement de payer',
    description: "Faites opposition à un commandement de payer.",
    fields: z.object({
...
Je vous prie de bien vouloir prendre note de cette opposition.${letterClosing}`,
  ...
  {
    id: 'LM-8.2',
    title: 'Opposition aux frais de poursuite',
    description: "Contestez des frais de poursuite que vous estimez abusifs.",
    fields: z.object({
      pursuitOffice: z.string().min(1, "Office des poursuites requis."),
      pursuitOfficeAddress: z.string().min(1, "Adresse de l'office requise."),
      pursuitNumber: z.string().min(1, "Numéro de poursuite requis."),
...
Je vous demande de vérifier ces frais et de me communiquer leur justification légale.${letterClosing}`,
  ...
  {
    id: 'LM-8.3',
    title: 'Demande de radiation de poursuite',
    description: "Demandez la radiation d'une poursuite après paiement.",
    fields: z.object({
      pursuitOffice: z.string().min(1, "Office des poursuites requis."),
      pursuitOfficeAddress: z.string().min(1, "Adresse de l'office requise."),
      pursuitNumber: z.string().min(1, "Numéro de poursuite requis."),
...
Je joins à la présente la preuve de paiement.${letterClosing}`,
  ...
  {
    id: 'LM-8.4',
    title: 'Convention de radiation de poursuite',
    description: "Proposez une convention de radiation avec le créancier.",
    fields: z.object({
      creditorName: z.string().min(1, "Nom du créancier requis."),
      creditorAddress: z.string().min(1, "Adresse du créancier requise."),
      pursuitNumber: z.string().min(1, "Numéro de poursuite requis."),
...
Cette proposition est valable 10 jours. En cas d'accord, je vous remercie de me retourner une copie signée de la présente.${letterClosing}`,
  ...
  {
    id: 'LM-8.5',
    title: 'Demande de rachat de dette',
    description: "Demandez le rachat de votre dette à une association d'aide.",
    fields: z.object({
...
const demarchageTemplates: Template[] = [
  {
    id: 'LM-9.1',
    title: 'Révocation démarchage 14 jours',
    description: "Révoquez un contrat conclu par démarchage dans le délai légal.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      contractDate: z.string().min(1, "Date du contrat requise."),
...
Je vous demande de confirmer cette révocation par écrit.${letterClosing}`,
  ...
  {
    id: 'LM-9.2',
    title: 'Révocation si délai non mentionné',
    description: "Révoquez un contrat si l'information sur le délai de révocation était absente.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
      contractDate: z.string().min(1, "Date du contrat requise."),
...
const envoiNonCommandeTemplates: Template[] = [
  {
    id: 'LM-10.1',
    title: 'Refus envoi non commandé',
    description: "Refusez de payer pour une marchandise non commandée.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
...
Je refuse tout paiement. L'article reste à votre disposition pendant 30 jours pour récupération à vos frais.${letterClosing}`,
  ...
  {
    id: 'LM-10.2',
    title: 'Refus et annulation de commande présumée',
    description: "Contestez une commande que vous n'avez jamais passée.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
...
const arnaqueTemplates: Template[] = [
  {
    id: 'LM-11.1',
    title: 'Contestation SMS surtaxés',
    description: "Contestez des frais pour des SMS surtaxés non sollicités.",
    fields: z.object({
...
Je refuse le paiement de ces frais et vous demande de bloquer tout numéro surtaxé sur ma ligne.${letterClosing}`,
  ...
  {
    id: 'LM-11.2',
    title: 'Annulation inscription annuaire abusive',
    description: "Contestez une inscription dans un annuaire obtenue de manière abusive.",
    fields: z.object({
...
const protectionDonneesTemplates: Template[] = [
  {
    ...
    description: "Demandez la rectification de données personnelles inexactes.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
...
Je vous prie de procéder à cette rectification dans un délai de 30 jours et de m'en confirmer l'exécution.${letterClosing}`,
  },
  {
    ...
    description: "Demandez à une entreprise quelles données elle détient sur vous.",
    fields: z.object({
      companyName: z.string().min(1, "Nom de l'entreprise requis."),
      companyAddress: z.string().min(1, "Adresse de l'entreprise requise."),
    }),
...
const bailTemplates: Template[] = [
  {
    id: 'LM-13.01',
    title: 'Résiliation ordinaire du bail',
    description: "Résiliez votre bail à l'échéance contractuelle.",
    fields: z.object({
...
Je vous remercie de bien vouloir m'adresser une confirmation de ma résiliation. Veuillez également me communiquer la date de l'état des lieux de sortie.${letterClosing}`,
  ...
  {
    id: 'LM-13.02',
    title: 'Résiliation anticipée du bail',
    description: "Proposez un candidat de remplacement pour une résiliation anticipée.",
    fields: z.object({
      landlordName: z.string().min(1, "Nom du bailleur requis."),
      landlordAddress: z.string().min(1, "Adresse du bailleur requise."),
      propertyAddress: z.string().min(1, "Adresse du bien loué requise."),
...
Ce candidat est solvable et disposé à reprendre le bail aux mêmes conditions. Je vous prie d'examiner sa candidature et de me libérer de mes obligations locatives.${letterClosing}`,
  ...
  {
    id: 'LM-13.03',
    title: 'Contestation frais résiliation anticipée',
    description: "Contestez des frais excessifs liés à une résiliation anticipée.",
    fields: z.object({
      landlordName: z.string().min(1, "Nom du bailleur requis."),
      landlordAddress: z.string().min(1, "Adresse du bailleur requise."),
      propertyAddress: z.string().min(1, "Adresse du bien loué requise."),
...
Conformément à l'article 264 CO, seul le dommage réellement subi peut être facturé au locataire. Je vous demande de justifier ces frais ou d'y renoncer.${letterClosing}`,
  ...
  {
    id: 'LM-13.04',
    title: 'Demande de baisse de loyer',
    description: "Demandez une réduction de loyer suite à une baisse du taux hypothécaire.",
    fields: z.object({
      landlordName: z.string().min(1, "Nom du bailleur requis."),
      landlordAddress: z.string().min(1, "Adresse du bailleur requise."),
      propertyAddress: z.string().min(1, "Adresse du bien loué requise."),
...
Conformément à l'article 270a CO, je vous prie de me répondre dans un délai de 30 jours.${letterClosing}`,
  ...
  {
    id: 'LM-13.05',
    title: 'Contestation hausse de loyer',
    description: "Contestez une augmentation de loyer que vous estimez injustifiée.",
    fields: z.object({
      landlordName: z.string().min(1, "Nom du bailleur requis."),
      landlordAddress: z.string().min(1, "Adresse du bailleur requise."),
      propertyAddress: z.string().min(1, "Adresse du bien loué requise."),
...
Conformément à l'article 270b CO, je me réserve le droit de saisir l'autorité de conciliation dans le délai de 30 jours.${letterClosing}`,
  ...
  {
    id: 'LM-13.06',
    title: 'Consignation du loyer',
    description: "Informez le bailleur de la consignation du loyer pour défaut non réparé.",
    fields: z.object({
      landlordName: z.string().min(1, "Nom du bailleur requis."),
      landlordAddress: z.string().min(1, "Adresse du bailleur requise."),
      propertyAddress: z.string().min(1, "Adresse du bien loué requise."),
...
const plaintesFormulairesTemplates: Template[] = [
  {
    id: 'LM-14.01',
    title: 'Plainte ElCom hausse électricité',
    description: "Déposez une plainte auprès de l'ElCom concernant une hausse tarifaire.",
    fields: z.object({
...
const contratsModelesTemplates: Template[] = [
  {
    ...
    description: "Transférez une créance à un tiers.",
    fields: z.object({
...
_________________              _________________`,
  },
  {
    ...
    description: "Établissez un contrat de prêt entre particuliers.",
    fields: z.object({
...
_________________              _________________`,
  },
  {
    ...
    description: "Établissez un contrat de prestation de services indépendants.",
    fields: z.object({
...
_________________              _________________`,
  },
  {
    ...
    title: "Convention d'accord",
    description: "Formalisez un accord amiable entre deux parties.",
    fields: z.object({
...
_________________              _________________`,
  },
  {
    ...
    title: 'Donation avec condition',
    description: "Effectuez une donation sous condition.",
    fields: z.object({
...
_________________              _________________`,
  },
  {
    ...
    title: 'Donation avec charge',
    description: "Effectuez une donation avec obligation pour le donataire.",
    fields: z.object({
      donorName: z.string().min(1, "Nom du donateur requis."),
      donorAddress: z.string().min(1, "Adresse du donateur requise."),
      doneeName: z.string().min(1, "Nom du donataire requis."),
...
_________________              _________________`,
  },
  {
    ...
    title: 'Reconnaissance de dettes',
    description: "Formalisez une dette par écrit.",
    fields: z.object({
      debtorName: z.string().min(1, "Nom du débiteur requis."),
      debtorAddress: z.string().min(1, "Adresse du débiteur requise."),
      creditorName: z.string().min(1, "Nom du créancier requis."),
...
_________________`,
  },
  {
    ...
    title: 'Contrat travail domestique (horaire)',
    description: "Engagez du personnel de maison avec un salaire horaire.",
    fields: z.object({
      employerName: z.string().min(1, "Nom de l'employeur requis."),
...
_________________              _________________`,
  },
  {
    ...
    title: 'Contrat travail domestique (mensuel)',
    description: "Engagez du personnel de maison avec un salaire mensuel.",
    fields: z.object({
      employerName: z.string().min(1, "Nom de l'employeur requis."),
      employerAddress: z.string().min(1, "Adresse de l'employeur requise."),
      employeeName: z.string().min(1, "Nom de l'employé requis."),
...
export const templateCategories: TemplateCategory[] = [
  {
    ...
    description: 'Gestion de votre assurance maladie obligatoire et complémentaire.',
    icon: 'Heart',
  ...
  },
  {
    id: 'garantie',
    title: 'Garantie',
    description: 'Faites valoir vos droits de garantie pour des produits ou services défectueux.',
    icon: 'Shield',
  ...
  },
  {
    ...
    description: "Exigez l'exécution correcte des obligations contractuelles.",
    icon: 'FileText',
  ...
  },
  {
    id: 'resiliation',
    title: 'Résiliation',
    description: 'Modèles de lettres pour résilier divers types de contrats.',
    icon: 'XCircle',
  ...
  },
  {
    id: 'annulation',
    title: 'Annulation',
    description: "Demandez l'annulation de contrats pour divers motifs.",
    icon: 'XCircle',
  ...
  },
  {
    ...
    description: 'Réclamations pour retards, annulations de vols ou problèmes de bagages.',
    icon: 'Plane',
  ...
  },
  {
    id: 'recouvrement',
    title: 'Recouvrement',
    description: 'Contestez des frais de recouvrement abusifs.',
    icon: 'Handshake',
  ...
  },
  {
    id: 'poursuites',
    title: 'Poursuites',
    description: 'Actions relatives à une procédure de poursuite.',
    icon: 'Gavel',
  ...
  },
  {
    id: 'demarchage',
    title: 'Démarchage',
    description: 'Révocation de contrats conclus par démarchage.',
    icon: 'Megaphone',
    templates: demarchageTemplates,
  },
  {
    id: 'envoi-non-commande',
    title: 'Envoi non commandé',
    description: 'Gérez la réception de marchandises non sollicitées.',
    icon: 'PackageX',
  ...
  },
  {
    id: 'arnaque',
    title: 'Arnaque',
    description: 'Contestez des frais liés à des arnaques.',
    icon: 'AlertTriangle',
  ...
  },
  {
    ...
    description: 'Exercez vos droits concernant vos données personnelles.',
    icon: 'Database',
  ...
  },
  {
    id: 'bail',
    title: 'Bail',
    description: 'Modèles de lettres pour la gestion de votre contrat de location.',
    icon: 'Home',
    templates: bailTemplates,
  },
  {
    id: 'plaintes-formulaires',
    title: 'Plaintes et formulaires',
    description: 'Plaintes officielles et autres formulaires.',
    icon: 'FileWarning',
  ...
  },
  {
    ...
    description: 'Créez divers contrats pour des situations personnelles.',
    icon: 'BookUser',
